...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { address: @point.address, anydesk: @point.anydesk, co: @point.co, isp: @point.isp, name: @point.name, vpn: @point.vpn } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { address: @point.address, anydesk: @point.anydesk, co: @point.co, isp: @point.isp, name: @point.name, vpn: @point.vpn } }
