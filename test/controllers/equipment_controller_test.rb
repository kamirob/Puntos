...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { fixed_assets: @equipment.fixed_assets, name: @equipment.name, serial: @equipment.serial } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { fixed_assets: @equipment.fixed_assets, name: @equipment.name, serial: @equipment.serial } }
